...
function CreateToDoListForSmall({ onCloseModal, toDoToEdit = {} }) {
  ...
  return (
    <div>
      ...
      <form
        className=" m-4 my-8  grid grid-cols-1 "
      ...
      >
        ...
        <input
          ...
          className="my-4 mr-8 w-1/2 rounded-2xl border-2 border-gray-600 px-6 py-4 text-2xl !outline-none transition-all duration-75 max-[767px]:my-1 max-[767px]:w-full  "
          {...register("tasks", {
            required: "Please enter task ",
          })}
        />
        <span className="mx-4 mt-6 p-4 text-2xl text-red-500 max-[767px]:mt-0">
        ...
        <input
          type="date"
          id="deadline"
          className="my-4 w-1/2 rounded-2xl  border-2 border-gray-600 px-6 py-4 text-2xl !outline-none transition-all duration-75 max-[767px]:my-1 max-[767px]:w-full  "
          {...register("deadline", {
        ...
        <select
          id="priority"
          name="priority"
          className="my-4 w-1/2 rounded-2xl border-2 border-gray-600 px-8 py-4 text-2xl !outline-none transition-all duration-75 max-[767px]:my-1 max-[767px]:w-full "
          {...register("priority", {
        ...
        <span className="mx-4 mt-6 p-4 text-2xl text-red-900 max-[767px]:mt-0">
        ...
        <button
          className="ml-8 rounded-2xl border-2 border-gray-400 bg-red-400 px-6 py-4 text-2xl !outline-none max-[767px]:ml-0"
...
export default CreateToDoListForSmall;
