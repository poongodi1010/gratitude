...
function Header() {
  ...
  return (
    <>
      ...
      <header className=" overflox-x-scroll flex h-[110px] items-center gap-[0.4rem] border-b-2 border-b-black bg-[url('/banner8.jpeg')] bg-cover px-[4.8rem] lg:overflow-hidden  ">
        {/* <UserAvatar /> */}
        <SideBar />
