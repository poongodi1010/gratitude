...
function MainNav() {
  return (
    <nav className="max-[767px]:fixed max-[767px]:z-50 max-[767px]:bottom-0 max-[767px]:w-full max-[767px]:border-t-2 max-[767px]:border-t-black max-[767px]:bg-[url('/banner11.jpeg')]">
      <div>
        ...
        <ul className="mt-3 flex flex-row gap-[0.2rem] py-6 pl-32 font-[PT-serif] text-3xl font-bold  max-[767px]:bottom-0 max-[767px]:grid max-[767px]:w-full max-[767px]:grid-cols-[1fr_1fr_1fr_1fr_1fr] max-[767px]:pl-1  max-[767px]:text-[1.5rem] ">
          {/* <li>
          ...
          <li>
            <NavLink
              ...
              className="link p-8 max-[767px]:px-1"
            >
              {/* <HiOutlineHomeModern /> */}
